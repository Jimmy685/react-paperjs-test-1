...
import {PageChange, Redo, Undo} from './RedoAndUndo'
    ...
    const FunctionMap = (ToolType: string) => {
        ...
        switch (ToolType) {
            ...
            case 'pen':
                return ToolFreePen;
            case 'segment':
                return ToolDrawSegment;
            case 'text':
                return ToolPointText;
            case 'edit':
                return ToolEditPath;
            case 'enlarge':
                return ToolEnlarge;
        ...
        <Sider width={48} className="me-left-bar">
            <div>
                <Tooltip placement="right" title={"pen"}>
                    <Button type="primary" shape="circle" onClick={FunctionMap("pen")}><IconFont
                        type="icon-pen"/></Button>
                </Tooltip>
                ...
                <Tooltip placement="right" title={"circle"}>
                    <Button type="primary" shape="circle" onClick={FunctionMap("circle")}><IconFont
                        type="icon-Select-1"/></Button>
                </Tooltip>
                ...
                <Tooltip placement="right" title={"translate"}>
                    <Button type="primary" shape="circle" onClick={FunctionMap("translate")}><IconFont
                        type="icon-hand"/></Button>
                </Tooltip>
                ...
                <Tooltip placement="right" title={"edit"}>
                    <Button type="primary" shape="circle" onClick={FunctionMap("edit")}><IconFont
                        type="icon-Link-Select"/></Button>
                </Tooltip>
                <Tooltip placement="right" title={"rotate"}>
                    <Button type="primary" shape="circle" onClick={FunctionMap("rotate")}><IconFont
                        type="icon-Link-Select"/></Button>
                </Tooltip>
                <Tooltip placement="right" title={"undo"}>
                    <Button type="primary" shape="circle" onClick={Undo}><IconFont
                        type="icon-zoom"/></Button>
                </Tooltip>
                <Tooltip placement="right" title={"redo"}>
                    <Button type="primary" shape="circle" onClick={Redo}><IconFont
                        type="icon-zoom"/></Button>
                </Tooltip>
            </div>
        </Sider>
